...
// nuestroTitulo=document.textContent(h1)
...
nuestroTitulo.textContent = 'Hola!' //+ prompt('cómo te llamás?')
...
document.querySelector("img").src="img/alicia (2).png"
...
nuestroTitulo.style.backgroundColor = 'pink'

//const nuestroWebsite=
 document.querySelector('.website').style.fontSize= '19px' //juntar las dos cosas está mal?
//nuestroWebsite.style.fontSize ='20px'
