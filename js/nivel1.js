...
/*
let nombreDelCreador;
let edadDelMismo;
nombreDelCreador = 'Fede González';
edadDelMismo = '21 años';
alert(nombreDelCreador);
alert(edadDelMismo);
*/
...
// que los alerts no aparezcan cada vez, y para que los errores no hagan que el programa se detengaC
...
let diez = 10
let doce = 12
let resultadoSuma = diez + doce
alert (resultadoSuma)
let resultadoMultiplicacion =diez * doce
...
//let vasosActuales = sumar(vasosNuevos, vasosViejos)

//console.log ('tengo ' + vasosActuales + ' vasos en mi casa')
// Consejo: Dejá las funciones como están, no las comentes, las vamos a usar de nuevo.
//let edadUsuario = prompt('por favor, ingresar edad', '30')
/*
...
*/
// crear una función que tome como parámetro el año actual y el año
// de nacimiento y calculen la edad del usuario (más o menos)
// Preguntar las variables al usuario y guardarlos en 2 variables
// Ejecutar la función con estos datos
//imprimir resultado en la consola

/*function edad (año1, año2){
    return 'Tu edad es de: ' + (año2 - año1)
};

let añoNac = prompt('¿En qué año naciste?');
añoNac = Number(añoNac);
let añoHoy = prompt ('¿Qué año es el actual?');
añoHoy=Number(añoHoy);

console.log(
    edad(añoNac, añoHoy) + ' años');*/
...
//"Es mejor si la función no está dependiendo de lo que esté afuera, por el principio de responsabilidad"
...
function calcularSalarioDiario (salarioMensual){
    const diasEnUnMes = 28
    return salarioMensual/diasEnUnMes
};

function calcularSalarioHora (salarioDiario){
    const horasDeUnaJornada = 8
    return salarioDiario/horasDeUnaJornada
};

let salarioAnualUsuario = Number(prompt('Por favor, ingresá el monto de tu salario mensual para poder calcular tu salario anual'))
salarioAnual = calcularSalarioAnual (salarioAnualUsuario)
console.log('Tu salario anual es de '+salarioAnual)

let salarioMensualUsuario=Number(prompt('Por favor, para calcular tus ingresos mensuales, ingresá tus ingresos anuales'))
salarioMensual= calcularSalarioMensual (salarioMensualUsuario)
console.log('Tu salario mensual es de ' + salarioMensual)

let salarioDiarioUsuario = Number(prompt('Por favor, ingresá tu salario mensual para poder calcular tu salario diario'))
salarioDiario = calcularSalarioDiario(salarioDiarioUsuario)
console.log('Tu salario diario es de '+salarioDiario)

let salarioHorarioUsuario =Number(prompt('Por favor, ingrese su salario diario, para poder calcular su salario por hora.'))
salarioHorario= calcularSalarioHora(salarioHorarioUsuario)
console.log('Tu salario por hora es de '+ salarioHorario)
//console.log('Tu salario por hora es de '+ calcularSalarioHora(salarioHorarioUsuario))
*/
...
/*
let salarioAnual= Number(prompt('Si quieres consultar tu salario mensual, inserta tu salario anual'));
...
//};
//let salarioMensual=Number(prompt('Si quieres conocer tu salario mensual, ingresa tu salario anual'))
//console.log('Tu salario mensual es de ' + calcularSalarioAnual(salarioMensual))
...
//      Vamos a decirle a la máquina qué función tiene que correr, dependiendo del operador 
//      artmético (+, -, /, *, etc.)
...
//
//const operador = prompt('Insertar si queres sumar, restar, dividir, o multiplicar')
/*const numeroCualquiera1=22;
const numeroCualquiera2=33;
let resultado
*/
///if (operador == '+'){
//resultado = sumar(numeroCualquiera1, numeroCualquiera2)
//} else {
///console.log   No está mal, pero no cumple con el principio responsabilidad mínima.
//  resultado = restar (numeroCualquiera1, numeroCualquiera2)
//}

//console.log('El resultado de '+numeroCualquiera1+' '+operador+' '+numeroCualquiera2+' = '+resultado);


//console.log(
//`El resultado de ${numeroCualquiera1} ${operador} ${numeroCualquiera2} = ${resultado}`
//)
...
const numero1 = prompt('Insertar el primer número para operar:')
const numero2 = prompt('Insertar el segundo número para operar:')
let resultado
if (operador == '+') {
...
} else { console.log('Por favor, recargá la página e ingresá "-", "+", "/", o "*"') }

console.log(
    `El resultado de ${numero1} ${operador} ${numero2} = ${resultado}`)
...
if (consultaUsuario.toLowerCase() == 'si') {
...
}else if (consultaUsuario.toLowerCase() == 'no'){
    console.log ('Por favor, retirate.')
